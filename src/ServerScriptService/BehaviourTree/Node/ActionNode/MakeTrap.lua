...
--[[
    Noeud MakeTrap: pose un piège à l'emplacement actuel du chasseur
    ...
    @return Status.SUCCESS si le piège est posé avec succès,
            Status.RUNNING si la pose du piège est en cours,
            Status.FAILURE si le piège ne peut pas être posé
]]
